...
Stack* CreateStack();
//Stack을 생성하는 함수 선언 입니다.
void Push(Stack* stack, struct TreeNode* treeNode);
//Stack에 노드를 추가하는 (push) 함수 선언 입니다. 넘어오는 인자는 추가할 노드와 추가할 스택입니다.
struct TreeNode* Pop(Stack* stack);
//Stack에 노드를 제거하는 (pop) 함수 선언 입니다. 넘어오는 인자는 제거할 스택입니다.
int IsStackEmpty(Stack* stack);
//Stack이 비어있는지 확인하는 함수 선언 입니다. 넘어오는 인자는 확인할 스택입니다.
void FreeStack(Stack* stack);
//Stack을 해제하는 함수입니다. 넘어오는 인자는 해제할 스택입니다.
