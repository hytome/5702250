...
def main():
    ...
    print(f"I will think of a point somewhere between (1, 1) and ({MAX_COORDINATE}, {MAX_COORDINATE}) and give hints until you guess it.")
...
def print_overall_stats(total_games, total_guesses, best_game_guesses):
    ...
    print(f"Best game     = {best_game_guesses}")
